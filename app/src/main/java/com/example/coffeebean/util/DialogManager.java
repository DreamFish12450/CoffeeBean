...
public class DialogManager {
    ...
    public synchronized void add(DialogParam dialogParam) {
        if (dialogParam != null && dialogParam.getDialog() != null) {
            if (mDialogs == null) {
                mDialogs = new ArrayList<DialogParam>();
            }
            dialogParam.getDialog().setOnShowListener(new DialogInterface.OnShowListener() {
                @Override
            ...
            dialogParam.getDialog().setOnDismissListener(new DialogInterface.OnDismissListener() {
                @Override
